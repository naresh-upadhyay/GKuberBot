...
START_BALANCE = Decimal("10000")  # BTC needs larger base
...
print("🚀 Starting BTC Breakout + Volume backtest...")
...
for i in range(RANGE_LOOKBACK + 100, len(df)):
    ...
    if pending_breakout:
        ...
        strong_close = price > range_high_at_break * Decimal("1.001")
        volume_spike = row["v"] > row["avg_vol"] * VOLUME_MULTIPLIER
        wick_ok = upper_wick < body * 0.7   # BTC cleaner, slightly relaxed
...
print("\n====== BTC BREAKOUT + VOLUME BACKTEST RESULT ======")
