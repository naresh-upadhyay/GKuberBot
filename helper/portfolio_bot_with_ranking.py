...
LOOKBACK_MONTHS = 6          # eligibility window
RANK_LOOKBACK = 20           # ranking window (≈3–4 days)
...
MAX_OPEN_TRADES = 1          # meme-coin safety
# ==========================================
...
# ================= SHORT-TERM RANKING (FIXED) =================
def rank_coins_short_term(eligible_data, lookback):
    scores = {}
    ...
    for sym, df in eligible_data.items():
        ...
        scores[sym] = recent_return

    ranked = sorted(scores.items(), key=lambda x: x[1], reverse=True)
    return ranked[0][0] if ranked else None


top_coin = rank_coins_short_term(eligible, RANK_LOOKBACK)

print("\n===== TOP RANKED COIN (SHORT-TERM) =====")
print(top_coin)
print("=======================================\n")
