...
ATR_PERIOD = 14
ATR_MULT = 1.5                  # trailing stop multiplier
...
if trades:
    ...
    print(f"Average Win      : {np.mean(wins):.2f} USDT")
    print(f"Average Loss     : {np.mean(losses):.2f} USDT")
